...
export const SAMPLE_FREQUENCY = process.env.SAMPLE_FREQUENCY || 10
export const CONFIG_UPDATE_FREQUENCY = process.env.CONFIG_UPDATE_FREQUENCY || 2
export const PROTOCOL = process.env.PROTOCOL || "MQTT"
export const PROXY_PORT = process.env.PROXY_PORT || 8989
